...
const SITE_TOOLS = [
  ...
  { name: 'URL Slug Generator',           href: 'tools/slug-generator.html',           tag: 'text',        icon: '🔗', desc: 'Convert titles to clean SEO-friendly URL slugs' },
  ...
  { name: 'Hash Generator',               href: 'tools/hash-generator.html',           tag: 'generate',    icon: '⌗', desc: 'Generate MD5, SHA-1, SHA-256, SHA-512 from text or file' },
  ...
  { name: 'MIME Types Reference',         href: 'tools/mime-types.html',               tag: 'reference',   icon: '📋', desc: 'Find the correct Content-Type header for any file extension' },
  { name: 'Contrast Checker (WCAG)',      href: 'tools/color-contrast-aa.html',        tag: 'design',      icon: '⚖️', desc: 'Test color pairs against WCAG AA/AAA accessibility standards' },
  ...
  { name: 'Compress Image to 100KB',      href: 'tools/compress-to-100kb.html',        tag: 'image',       icon: '🗜️', desc: 'Compress images to a specific target file size (100KB, 50KB…)' },
  { name: 'WCAG Contrast Checker',        href: 'tools/contrast-checker.html',         tag: 'design',      icon: '⚖️', desc: 'Check WCAG AA and AAA color contrast ratios for accessibility' },
  ...
  { name: 'HTML Formatter',               href: 'tools/html-formatter.html',           tag: 'format',      icon: '🏷️', desc: 'Beautify or minify HTML with customizable indentation' },
  ...
  { name: 'PNG to JPG Converter',         href: 'tools/png-to-jpg.html',               tag: 'image',       icon: '🖼️', desc: 'Convert PNG images to JPG with adjustable quality' },
  ...
  { name: 'Roman Numeral Converter',      href: 'tools/roman-numerals.html',           tag: 'convert',     icon: '🔢', desc: 'Convert between Arabic numbers and Roman numerals' },
  ...
  { name: 'String Escape / Unescape',     href: 'tools/string-escape.html',            tag: 'encode',      icon: '🔤', desc: 'Escape or unescape strings for JSON, JavaScript and HTML' },
