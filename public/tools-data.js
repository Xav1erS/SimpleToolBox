...
const SITE_TOOLS = [
  ...
  { name: 'Tax Calculator',          href: 'tools/tax-calculator.html',          tag: 'calculator', icon: '🧾', desc: 'Calculate sales tax, reverse tax, or estimate US federal income tax by bracket — instant results' },
  ...
  { name: 'Body Fat Calculator',     href: 'tools/body-fat-calculator.html',     tag: 'calculator', icon: '💪', desc: 'Estimate body fat percentage using the US Navy circumference method — metric and imperial, instant result' },
  ...
  { name: 'Scientific Calculator',       href: 'tools/scientific-calculator.html',       tag: 'calculator', icon: '🧮', desc: 'Full scientific calculator with trig, log, powers, memory, and keyboard support' },
  { name: 'Retirement Calculator',       href: 'tools/retirement-calculator.html',       tag: 'calculator', icon: '🏦', desc: 'Estimate retirement savings from current balance, monthly contributions, years, and return rate' },
  ...
  { name: 'Time Duration Calculator',    href: 'tools/time-duration-calculator.html',    tag: 'calculator', icon: '⏱️', desc: 'Add or subtract multiple time durations — enter hours, minutes, seconds for instant total' },
  { name: 'Aspect Ratio Calculator',     href: 'tools/aspect-ratio-calculator.html',     tag: 'calculator', icon: '📐', desc: 'Calculate missing width, height, or aspect ratio — lock ratio and scale dimensions freely' },
  { name: 'Pace Calculator',             href: 'tools/pace-calculator.html',             tag: 'calculator', icon: '🏃', desc: 'Calculate running pace, finish time, or distance — supports km and miles with race presets' },
  { name: 'Tip Splitter',                href: 'tools/tip-splitter.html',                tag: 'calculator', icon: '🍽️', desc: 'Calculate tip and split a bill between any number of people — choose percentage or custom amount' },
  { name: 'Age in Days',                 href: 'tools/age-in-days.html',                 tag: 'calculator', icon: '🎂', desc: 'Find out exactly how many days, weeks, hours old you are — with upcoming milestone dates' },
  ...
  { name: 'Loan Amortization Calculator', href: 'tools/loan-amortization-calculator.html', tag: 'calculator', icon: '📊', desc: 'Generate a full loan amortization schedule — monthly principal, interest, and balance breakdown' },
];
